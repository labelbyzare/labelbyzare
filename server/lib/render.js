...
const publicPageHeaders = require('./page-cache');
const e = C.escape;
...
function response(body, statusCode=200, cache=true) { return {statusCode,headers:{'Content-Type':'text/html; charset=utf-8',...(cache && statusCode===200 ? publicPageHeaders() : {'Cache-Control':'no-store'}),'X-Content-Type-Options':'nosniff'},body}; }
