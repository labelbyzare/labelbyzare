    ...
    <div class="product-card${stocked ? "" : " is-soldout"}">
      <a href="product.html?id=${p.id}">
        <div class="product-media">
          ...
          <img class="img-secondary" src="${p.img2}" alt="" loading="lazy">
        </div>
      </a>
      ...
      <div class="quick-add">
        <button class="btn btn-solid btn-block btn-sm" onclick="location.href='product.html?id=${p.id}'">${stocked ? "Quick View" : "Sold Out"}</button>
      </div>
      <a href="product.html?id=${p.id}">
